...
MySQL - 11.5.2-MariaDB : Database - northwind
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`northwind` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci */;
...
/*Data for the table `employee_privileges` */
...
/*Data for the table `inventory_transaction_types` */
...
/*Data for the table `order_details_status` */
...
/*Data for the table `orders_tax_status` */
...
CREATE TABLE `purchase_orders` (
  ...
  CONSTRAINT `fk_purchase_orders_employees` FOREIGN KEY (`created_by`) REFERENCES `employees` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
/*Data for the table `sales_reports` */
